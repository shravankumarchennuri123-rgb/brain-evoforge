...
PORTABLE_SEEDS = [
    ...
    ("rank(ts_delta(close,5)/ts_shift(close,5))", "price_momentum", "Short-horizon price change."),
...
class CandidateGenerator:
    ...
    def initial(self, n: int = 12) -> list[tuple[str, str, str, str]]:
        ...
        useful = [f for f in self.fields if any(k in f.lower() for k in ("operating_income", "free_cash_flow", "est_eps", "sales", "assets", "equity"))]
